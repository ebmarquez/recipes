---
title: Budget Beef Picadillo with Potatoes and Jalapeno
type: Recipe
cuisine: Mexican
category: Main Dish
tags:
...
Serve with tortillas or rice and finish with cilantro or a squeeze of lime.

## Doneness and Food Safety

- Cook ground beef to an internal temperature of at least 160 degrees F.
- The potatoes are ready when a fork slides through without resistance.
- Refrigerate leftovers within two hours of cooking.
- Reheat leftovers to 165 degrees F.

## Budget and Protein Tips

- Add one drained can of pinto or black beans to make six servings.
- Use leftover baked potatoes and reduce the covered cooking time.
- Frozen peas and carrots are inexpensive and require no chopping.
- Store-brand tomato sauce, broth, and spices work well in this dish.
- Serve with rice after demanding training for additional carbohydrates.
...
- **Milder version:** Remove the jalapeno seeds and white membrane.
- **Spicier version:** Keep the seeds or add a second jalapeno.
- **Lean version:** Use 90% lean beef or ground turkey.
- **Stretch the meal:** Add pinto beans, black beans, or another potato.
- **More vegetables:** Add diced carrots with the potatoes or corn near the end.
...
- Add broth and beans to turn it into a quick soup.
